 ...
 */
public class ServicesOnHostsByProjectPieChartAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		pieChart.setTitle(new Title("Services Distribution", "{" + getText("avgProjectActivityPieChart.title.style") + "}"));
