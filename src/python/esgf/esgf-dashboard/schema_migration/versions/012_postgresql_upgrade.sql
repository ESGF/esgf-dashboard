...
DROP TABLE IF EXISTS esgf_dashboard.cmip6_dmart_experiment_id_host_time CASCADE;
...
DROP TABLE IF EXISTS esgf_dashboard.cmip6_dmart_source_id_host_time CASCADE;
...
ALTER table esgf_dashboard.cmip6_dmart_clients_host_geolocation add constraint cmip6_dmart_clients_host_geolocation_1 unique (total_size, number_of_downloads, number_of_successful_downloads, average_duration, number_of_users, number_of_replica_downloads, latitude, longitude, country_id, host_name);');

select table_exists('cmip6_dmart_experiment_id_host_time', 'CREATE TABLE esgf_dashboard.cmip6_dmart_experiment_id_host_time (
  dmart_key bigserial PRIMARY KEY,
  total_size bigint,
  number_of_downloads bigint,
  number_of_successful_downloads bigint,
...
ALTER TABLE esgf_dashboard.cmip6_dmart_experiment_id_host_time OWNER TO dbsuper;
ALTER table esgf_dashboard.cmip6_dmart_experiment_id_host_time add constraint cmip6_dmart_experiment_id_host_time_1 unique (total_size, number_of_downloads, number_of_successful_downloads, average_duration, number_of_users, number_of_replica_downloads, month, year, host_name, experiment_id_name);');
...
ALTER table esgf_dashboard.cmip6_dmart_variable_host_time add constraint cmip6_dmart_variable_host_time_1 unique (total_size, number_of_downloads, number_of_successful_downloads, average_duration, number_of_users, number_of_replica_downloads, month, year, host_name, variable_code, variable_long_name, cf_standard_name);');
...
ALTER table esgf_dashboard.cmip6_dmart_dataset_host_time add constraint cmip6_dmart_dataset_host_time_1 unique (total_size, number_of_downloads, number_of_successful_downloads, average_duration, number_of_users, number_of_replica_downloads, month, year, host_name, dataset_name, dataset_version, datetime_start, datetime_stop);');

select table_exists('cmip6_dmart_source_id_host_time', 'CREATE TABLE esgf_dashboard.cmip6_dmart_source_id_host_time (
  dmart_key bigserial PRIMARY KEY,
  total_size bigint,
  number_of_downloads bigint,
  number_of_successful_downloads bigint,
...
ALTER TABLE esgf_dashboard.cmip6_dmart_source_id_host_time OWNER TO dbsuper;
ALTER table esgf_dashboard.cmip6_dmart_source_id_host_time add constraint cmip6_dmart_source_id_host_time_1 unique (total_size, number_of_downloads, number_of_successful_downloads, average_duration, number_of_users, number_of_replica_downloads, month, year, host_name, source_id_name);');
...
ALTER table esgf_dashboard.cmip6_dmart_realm_host_time add constraint cmip6_dmart_realm_host_time_1 unique (total_size, number_of_downloads, number_of_successful_downloads, average_duration, number_of_users, number_of_replica_downloads, month, year, host_name, realm_name);');
...
ALTER table esgf_dashboard.cross_dmart_project_host_geolocation add constraint cmip6_dmart_project_host_geolocation_1 unique (total_size, number_of_downloads, number_of_successful_downloads, number_of_replica_downloads, average_duration, number_of_users, host_name, project_name, latitude, longitude, country_id);');

delete from esgf_dashboard.registry where datmart='esgf_dashboard.cmip6_dmart_clients_host_geolocation';
delete from esgf_dashboard.registry where datmart='esgf_dashboard.cmip6_dmart_experiment_id_host_time';
delete from esgf_dashboard.registry where datmart='esgf_dashboard.cmip6_dmart_variable_host_time';
delete from esgf_dashboard.registry where datmart='esgf_dashboard.cmip6_dmart_dataset_host_time';
delete from esgf_dashboard.registry where datmart='esgf_dashboard.cmip6_dmart_source_id_host_time';
delete from esgf_dashboard.registry where datmart='esgf_dashboard.cmip6_dmart_realm_host_time';

insert into esgf_dashboard.registry values('esgf_dashboard.cmip6_dmart_clients_host_geolocation',0,0);
insert into esgf_dashboard.registry values('esgf_dashboard.cmip6_dmart_experiment_id_host_time',0,0);
...
insert into esgf_dashboard.registry values('esgf_dashboard.cmip6_dmart_source_id_host_time',0,0);
